...
\begin{filecontents*}{\jobname.xmpdata}
  \Title{Integrazione di Single Sign-On in Unix Pluggable Authentication Module (Unix PAM)}
  ...
  \Subject{Lo scopo della tesi è illustrare il lavoro eseguito con Athesys,
    ...
    Single Sign-On compatibile con Unix Pluggable Authentication Module (Unix PAM).}
...
\usepackage{float}  % per fissare le immagini
...
\input{capitoli/capitolo-2}             % Studio tecnologico
\input{capitoli/capitolo-3}             % Ricerca e sviluppo
