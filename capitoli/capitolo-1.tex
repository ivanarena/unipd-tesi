...
% TODO: spiega meglio cosa si intende, cosa vuol dire livello macchina e da sistema?
...
L'obiettivo del progetto del tirocinio era la ricerca e l'eventuale sviluppo di una soluzione che consentisse
...
% TODO: spiega cosa si intende per in modo nativo
...
messe a disposizione dall'azienda tramite la piattaforma open-source di virtualizzazione Proxmox.
...
Monokee \acrfull{oauth2} e di un provider \acrfull{oidc} che fornissero gli end-point e l'infrastruttura 
necessari alla comunicazione con il server di FreeIPA e la successiva implementazione degli stessi su di esso. 

Verificato il corretto funzionamento di questo sistema di autenticazione da \arcfull{cli}, ho proseguito cercando di implementare questo sistema anche tramite \acrfull{ssh} ma non sono riuscito a terminare l'implementazione prima del raggiungimento del monte ore totale a disposizione. 
